...
- key_actions 是一个字典，key=年份+干支，value=该年具体行动建议。必须从上方的「当前大运流年」数据中选择年份——优先选用神年✅和忌神年⚠️，不选平年。每个维度至少选2个年份，选完后在summary里解释为什么这些年份重要
- 建议要具体可操作，不要泛泛而谈
...
def _build_forecast_prompt(
    ...
    lines.append("\n选key_years规则：优先选用神年✅和忌神年⚠️，它们代表运势转折点。平年一般不选。")
