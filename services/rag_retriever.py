...
STAGE_PRIORITY = {
    ...
    "yongshen": {      # 取用神
        "primary": ["ziping"],
        "supplementary": ["dishui", "qiongtong"],
    },
    "wangshuai": {     # 断旺衰
        "primary": ["dishui"],
...
PATTERN_KEYWORD_MAP = {
    "正官格": ["正官", "官星", "财生官", "印护官", "伤官克官", "官杀混杂"],
    "七杀格": ["七杀", "食神制杀", "印化杀", "杀无制", "财党杀"],
    "正财格": ["正财", "食伤生财", "官护财", "比劫夺财"],
    "偏财格": ["偏财", "食伤生财", "官护财", "比劫夺财"],
    "正印格": ["正印", "官生印", "杀生印", "财破印"],
    "偏印格": ["偏印", "枭神", "财制枭", "枭神夺食"],
    "食神格": ["食神", "比劫生食", "食伤生财", "枭神夺食"],
    "伤官格": ["伤官", "印制伤官", "财泄伤官", "伤官见官", "伤官伤尽"],
    "建禄格": ["建禄", "官制禄", "食伤泄秀", "建禄无制"],
    "月刃格": ["月刃", "阳刃", "官杀制刃", "食伤泄刃", "冲刃"],
    "从弱格": ["从格", "真从", "假从", "从财", "从杀", "弃命"],
    "专旺格": ["从格", "从强", "从旺", "食伤泄秀", "曲直", "炎上", "稼穑", "从革", "润下"],
    "化气格": ["化气", "天干五合", "甲己化土", "乙庚化金", "丙辛化水", "丁壬化木", "戊癸化火"],
}
